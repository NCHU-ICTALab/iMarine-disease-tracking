...
# 與 config.ais_bbox 的外國 hub 方框一致。
FOREIGN_HUBS = [
    ("KRPUS", "釜山", 34.6, 35.6, 128.5, 129.7),
    ("KRINC", "仁川", 37.0, 37.9, 126.1, 127.1),
    ("JPTYO", "東京灣", 35.0, 35.9, 139.3, 140.2),
    ("JPUKB", "大阪灣", 34.4, 34.9, 135.0, 135.7),
    ("HKHKG", "香港/華南", 21.8, 22.9, 113.6, 114.8),
    ("SGSIN", "新加坡", 0.8, 1.7, 103.3, 104.4),
    ("IDJKT", "雅加達", -6.6, -5.6, 106.3, 107.4),
    ("PHMNL", "馬尼拉", 14.1, 15.1, 120.5, 121.5),
    ("THLCH", "曼谷/林查班", 12.8, 13.9, 100.3, 101.2),
]
